...
import controller.TelaCadastroPessoaController;
...
public class TelaCadastroPessoa extends JFrame implements ActionListener{
    ...
    private final TelaCadastroPessoaController controller; 

    public TelaCadastroPessoa(){
        super();

		this.controller = new TelaCadastroPessoaController(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        this.controller.fazerCadastro(e);
    ...
    public TelaCadastroPessoaController getController() {
        return controller;
    }
