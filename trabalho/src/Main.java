...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String recebeString, nome, marca, cor, tipoBico, material, nomePessoa, dataNasc, departamento, telefone,
                ...
                nomeCompra, id;
        int opcaoVendedor1, opcaoProduto, tamanho, i, opcaoCliente1, opcaoEditarPessoa, identificador4 = 0, quantidade,
                quantidadeCompra;
        int numProdutosCadas = 15, numPessoasCadas = 0, identificador = 0, identificador2 = 0;
